...
func (cd *ConfigDaemon) saveVersion(version types.ConfigVersion) error {
...
func (cd *ConfigDaemon) LoadVersions() error {
	cd.mu.Lock()
	defer cd.mu.Unlock()
...
func (cd *ConfigDaemon) GetVersion(version int) (*types.ConfigVersion, error) {
	cd.mu.RLock()
	defer cd.mu.RUnlock()
...
func (cd *ConfigDaemon) GetVersionDiff(fromVersion, toVersion int) (*types.DiffResult, error) {
	cd.mu.RLock()
	defer cd.mu.RUnlock()
