...
func NewMockDataplane() *MockDataplane {
	return &MockDataplane{
		...
		AddedRoutes:       make([]*types.StaticRoute, 0),
	}
}

func (m *MockDataplane) CreateInterface(cfg *types.InterfaceConfig) error {
...
func (m *MockDataplane) AddRoute(route *types.StaticRoute) error {
	m.AddedRoutes = append(m.AddedRoutes, route)
	return nil
}

func (m *MockDataplane) DelRoute(route *types.StaticRoute) error {
	return nil
}
