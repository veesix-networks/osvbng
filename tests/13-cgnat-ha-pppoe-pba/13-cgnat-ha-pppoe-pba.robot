...
*** Comments ***
CGNAT HA PPPoE PBA test suite for two-node BNG deployment.
Verifies SRG election, PPPoE sessions with CGNAT on active,
mapping sync to standby, switchover, and re-establishment on new active.
...
Suite Setup         Deploy HA CGNAT PPPoE Topology
Suite Teardown      Destroy HA CGNAT PPPoE Topology

*** Variables ***
${lab-name}         osvbng-cgnat-ha-pppoe-pba
${lab-file}         ${CURDIR}/13-cgnat-ha-pppoe-pba.clab.yml
...
Establish PPPoE Sessions On bng2
...
*** Keywords ***
Deploy HA CGNAT PPPoE Topology
    Deploy Topology    ${lab-file}

Destroy HA CGNAT PPPoE Topology
